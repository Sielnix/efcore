...
public partial class RelationalShapedQueryCompilingExpressionVisitor
{
    ...
    public sealed partial class ShaperProcessingExpressionVisitor : ExpressionVisitor
    {
        ...
        private static readonly MethodInfo ByteArrayAsSpanMethod = typeof(MemoryExtensions).GetMethods().Where(x => x.Name == nameof(MemoryExtensions.AsSpan) && x.GetGenericArguments().Count() == 1)
